...
TOPIC_FILES = {
    ...
    "/mavros/vision_pose/pose": "mavros_vision_pose_pose",
    ...
    "/robotac/fastlio_vision/path_a_pose_preview": "robotac_fastlio_vision_path_a_pose_preview",
    "/Odometry": "Odometry",
...
def build_report(args):
    ...
    phases = [
        ...
        _stream_phase(directory, "fastlio_pose_preview_stream", "/robotac/fastlio_vision/path_a_pose_preview",
                      args.min_preview_hz),
        _stream_phase(directory, "mavros_vision_pose_stream", "/mavros/vision_pose/pose",
                      args.min_vision_hz),
        ...
        _fastlio_health_phase(directory, output_enabled_expected=True,
                              phase_name="fastlio_vision_health"),
        _consumer_phase(directory, "mavros_vision_pose_consumer", "/mavros/vision_pose/pose",
                        args.mavros_node),
        _consumer_phase(directory, "mavros_setpoint_raw_consumer", "/mavros/setpoint_raw/local",
                        args.mavros_node),
        _no_stream_phase(directory, "read_only_no_vision_pose_stream", "/mavros/vision_pose/pose"),
