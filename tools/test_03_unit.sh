...
export PYTHONPATH="${workspace}/src/robotac_examples/src:${workspace}/src/robotac_localization/src:${workspace}/src/robotac_servo/src:${workspace}/src/robotac_mission/src${PYTHONPATH:+:${PYTHONPATH}}"
...
python3 -m unittest discover -s "${workspace}/src/robotac_mission/test" -p 'test_*.py'
